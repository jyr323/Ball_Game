...
public class Player1 extends Thread {
	...
	public void move() {
		while (background.p1_up == true || background.p1_down == true || background.p1_left == true
				|| background.p1_right == true) {
			if (background.p1_up == true && background.p1_left) {
				background.mg.p1_motion = 1;
				for (int i = 0; i < 40; i++) {
					if (background.mg.reset == true)
						break;
				...
				background.mg.p1_jump = false;
				background.mg.p1_motion = 0;
			} else if (background.p1_down == true && background.p1_right == true) {
