...
public class background extends JFrame implements KeyListener, ActionListener {
	...
	static Mygame mg; //실제 게임 진행 하면 클래스 선언
	static Mystart ms = new Mystart(); //실제 게임 진행 클래스 선언 및 객체화
	...
	public void actionPerformed(ActionEvent e) {
		...
		//전달받은 menuItem매게변수가'조작방법'일 경우
		else if(e.getSource() == mnKey) { 
			h.setVisible(true);
		}
		
		//전달받은 menuItem매게변수가'만든이'일 경우
